...
public abstract class ReusableAdapter<T> extends BaseAdapter {
	 ...
	 * 
	 *         2. 定义一个查找控件的方法，我们的思路是通过暴露公共的方法，调用方法时传递过来
	 *         控件id，以及设置的内容，比如TextView设置文本： public ViewHolder setText(int id,
	 *         CharSequence text){文本设置}
	 * 
	...
	public static class ViewHolder {
		...
		// 绑定ViewHolder与item
		public static ViewHolder bind(Context context, View convertView, ViewGroup parent, int listItemResource,
				int position) {
			ViewHolder holder;
			if (convertView == null) {
