...
public class PostData {
	public static String submit(String path, String phone, String password, String androidPK, String captcha) {
		...
		try {
			...
			String data = "LoginPhone=" + URLEncoder.encode(phone, "UTF-8") + "&LoginPassword="
					+ URLEncoder.encode(password, "UTF-8") + "&uuid=" + URLEncoder.encode(androidPK, "UTF-8")
					+ "&ShuRuyzm=" + URLEncoder.encode(captcha, "UTF-8");
